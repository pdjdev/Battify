...
namespace Battify
{
    public partial class OptionTabBt : UserControl
    {
        ...
        private void buttonPanel_Paint(object sender, PaintEventArgs e)
        {
            ...
            g.FillRoundedRectangle(new SolidBrush(Color.FromArgb(50,Color.White)), 0, 0, ((Panel)sender).Width, ((Panel)sender).Height, 10);
            
        }

        [Description("Determine if the tab is selected"), Category("Boolean")]
